...
std::ofstream error_x = std::ofstream("/home/lizhi/sample_test_result/online_result/error_x.txt");
std::ofstream error_y = std::ofstream("/home/lizhi/sample_test_result/online_result/error_y.txt");
std::ofstream error_z = std::ofstream("/home/lizhi/sample_test_result/online_result/error_z.txt");
...
void Interpolation::offlineInterpolation(LidarPerception& perception, std::vector<double>& timestamps,
    ...
    //lidarLinearInterpolation(interpolation_result, cam_lidar_time_by_ids);
